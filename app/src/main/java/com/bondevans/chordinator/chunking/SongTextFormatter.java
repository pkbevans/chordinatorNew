...
public class SongTextFormatter {
	...
	final static int T_TITLE = 0;
	final static int T_BYLINE = 1;
	final static int T_FREETEXT= 2;
	final static int T_LYRIC= 3;
	final static int T_CHORD= 4;
	static final int T_EOL_CHORDS = 5;
	static final int T_EOL_LYRICS = 6;
	static final int T_EOL = 7;

	private Song mSong;

	private StringBuilder mOutput= new StringBuilder();
	StringBuilder mLyrics= new StringBuilder();
	StringBuilder mChords= new StringBuilder();

	private boolean mLyricsPainted = true;
	private boolean mChordsPainted = true;
	private int mTransposeBy;
	private int mLineLength=0;
	private StringBuilder mPadding = new StringBuilder("                                                                                                                      ");
...
//			Log.d(TAG, "Lyrics   ["+mLyrics+"]");
	 ...
	 * @param txt text
	 * @param type type
	 * @return returns given text wrapped with appropriate html
	 */
