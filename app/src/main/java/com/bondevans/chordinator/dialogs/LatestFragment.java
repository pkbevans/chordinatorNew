...
public class LatestFragment extends DialogFragment{
	...
	private String[] mStrings = {
			"v7.0.0 - Improved - Re-built for latest sdk.",
			"v6.3.0 - Improved - {sot}..{eot} Tab text uses visible colour.",
			"v6.2.2 - Fixed - Sharing now works again.",
			"v6.2.2 - Fixed - First run creates /chordinator directory.",
